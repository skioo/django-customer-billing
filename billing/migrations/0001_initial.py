# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-10-25 13:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', djmoney.models.fields.CurrencyField(db_index=True, default='XYZ', max_length=3)),
                ('status', django_fsm.FSMField(choices=[('OPEN', 'Open'), ('CLOSED', 'Closed')], db_index=True, default='OPEN', max_length=20)),
                ('owner', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='billing_account', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Charge',
            fields=[
                ...
                ('amount', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), max_digits=12)),
                ('description', models.TextField(blank=True)),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='charges', to='billing.Account')),
            ],
        ),
        migrations.CreateModel(
            name='CreditCard',
            fields=[
                ...
                ('expiry_year', models.IntegerField(validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(99)])),
                ('expiry_date', models.DateField()),
                ('psp_uri', models.CharField(max_length=255, validators=[django.core.validators.RegexValidator('^\\w+:(\\w+/)*\\w+')])),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='credit_cards', to='billing.Account')),
            ],
        ),
        migrations.CreateModel(
            name='Invoice',
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('status', django_fsm.FSMField(choices=[('PENDING', 'Pending'), ('PAST_DUE', 'Past-due'), ('PAYED', 'Payed'), ('CANCELLED', 'Cancelled')], db_index=True, default='PENDING', max_length=20)),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='invoices', to='billing.Account')),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
            fields=[
                ...
                ('psp_uri', models.CharField(max_length=255, validators=[django.core.validators.RegexValidator('^\\w+:(\\w+/)*\\w+')])),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='transactions', to='billing.Account')),
                ('invoice', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='transactions', to='billing.Invoice')),
            ],
        ),
        migrations.AddField(
            model_name='charge',
            name='invoice',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='items', to='billing.Invoice'),
        ),
    ]
